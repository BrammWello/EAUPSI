        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="student_attendance.php"><i class="fas fa-table"></i><span>Attendance Requests</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Attendance List</h3>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            echo '<tr>
                                                <td><img class="rounded-circle me-2" width="30" height="30" src="assets/img/avatars/user.png">'. $row["names"]. '</td>
                                                <td>'. $row["email"]. '</td>
                                                <td>'. $row["earlycount"]. '</td>  
                                                <td>'. $row["latecounts"]. '</td>                                               
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><strong>Times Early</strong></td>
                                            <td><strong>Times Late</strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>

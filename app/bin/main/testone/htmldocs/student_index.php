...
<?php 
    ...
    $sqlone = "SELECT * FROM `students` WHERE `names` = '$studentname'";
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="student_index.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="class_registration.php"><i class="fas fa-table"></i><span>Class Registration</span></a></li>
                </ul>
                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Total classes</span></div>
                            ...
                            <?php
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        if(in_array($row['classname'], $str_arr)) {                                  
                                            echo '<div class="col-lg-6 mb-4">
                                            <div class="card textwhite bg-secondary text-white shadow">
                                                <div class="card-body">
                                                    <p class="m-0">'. $row["classname"]. '</p>
                                                    <p class="text-white-50 small m-0">
                                                    
                                                        <form method="post" action="class_request_scripts.php">
                                                        <input type="date" id="start" name="classdaterequest"
                                                        value="2022-07-22"
                                                        min="2022-01-01" max="2023-12-31">
                                                        <input type="hidden" id="classnamerequest" name="classnamerequest"
                                                        value="'. $row["classname"]. '">
                                                        <input type="hidden" id="classnamerequest" name="lecid"
                                                        value="'. $row["lecid"]. '">
                                                        <button class="btn btn-primary" type="submit">Make Attendance Request</button>
                                                        </form>

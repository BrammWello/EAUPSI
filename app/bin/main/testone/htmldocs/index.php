...
session_start();
    ...
    $sql = "SELECT * FROM `classes` WHERE `lecid` = '$userid'";
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo $totalclasses ?></span></div>
                                        </div>
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        <div class="card textwhite bg-secondary text-white shadow">
                                            <div class="card-body">
                                                ...
                                                <p class="text-white-50 small m-0">' . $row["lecname"].'</p>
                                            </div>
                                        </div>
                                    </div>';
                                    }

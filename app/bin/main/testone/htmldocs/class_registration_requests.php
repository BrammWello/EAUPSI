...
if ($_SESSION['names'] == NULL) {
    ...
    $sql = "SELECT * FROM registration WHERE `registrationstatus` = 'pending' AND `lecid` = '$lecsessionid'";
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="class_registration_requests.php"><i class="fas fa-file"></i><span>Class Registration List</span></a></li>
                </ul>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            echo '<tr>
                                                ...
                                                <td>'. $row["registrationclass"]. '</td>
                                                
                                                <form method="post" action="change_registration_request.php">
                                                    <input type="hidden" id="classnamerequest" name="studentname"
                                                    value="'. $row["studentname"]. '">
                                                    <input type="hidden" id="classnamerequest" name="registrationclass"
                                                    value="'. $row["registrationclass"]. '">
                                                    <input type="hidden" id="classnamerequest" name="regid"
                                                    value="'. $row["registrationid"]. '">
                                                    <td><button class="btn btn-primary" type="submit" value="accept" name="change">Admit</button></td>
